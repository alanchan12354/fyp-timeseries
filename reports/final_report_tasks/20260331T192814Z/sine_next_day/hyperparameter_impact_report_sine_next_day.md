...
| :--- | ---: | ---: | ---: | ---: | ---: | :--- | :--- |
| Baseline-LR | 4.59256e-08 | 4.80704e-08 | 3.58372e-08 | 0.00017406 | 97.02% | `{"details": "{\"flattened_sequence\": true, \"model\": \"LinearRegression\", \"seq_len\": 30}", "source": "best_tuned_comparison_csv"}` | `best_tuned_lstm_comparison-20260331T193731Z-baseline-lr` |
| LSTM | 1.49605e-06 | 1.10954e-07 | 2.1573e-07 | 0.000261717 | 98.64% | `{"hidden": 128, "input_size": 8, "layers": 2, "random_seed": 42}` | `lstm_experiment-20260331T192836Z` |
| RNN | 1.72386e-06 | 1.60138e-06 | 1.67542e-06 | 0.000966363 | 94.86% | `{"hidden": 64, "input_size": 8, "layers": 2, "random_seed": 42}` | `rnn_experiment-20260331T193049Z` |
| GRU | 3.14724e-06 | 2.29354e-06 | 2.36252e-06 | 0.00118988 | 95.60% | `{"hidden": 64, "input_size": 8, "layers": 2, "random_seed": 42}` | `gru_experiment-20260331T193003Z` |
| Transformer | 1.19913e-05 | 1.05919e-05 | 0.000518755 | 0.00250103 | 88.89% | `{"d_model": 64, "dropout": 0.1, "input_size": 8, "nhead": 4, "num_layers": 2, "random_seed": 42}` | `transformer_experiment-20260331T193359Z` |
