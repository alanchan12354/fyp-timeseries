...
| Model | MAE | RMSE | Directional Accuracy (DA) | Best Val MSE |
| :--- | :--- | :--- | :--- | :--- |
| **RNN** | 0.00680 | 0.01010 | 47.37% | 1.40e-4 |
| **LSTM** | 0.00662 | **0.00989** | 46.55% | **1.34e-4** |
| **GRU** | **0.00657** | 0.01005 | **54.28%** | 1.38e-4 |
| **Transformer** | 0.00900 | 0.01273 | 46.71% | 1.96e-4 |
...
| Model | MAE | RMSE | Directional Accuracy (DA) |
| :--- | :--- | :--- | :--- |
| **Persistence** | 0.00952 | 0.01441 | 52.63% |
| **Linear Regression** | 0.00665 | 0.00996 | 52.14% |
...
### Test Set Performance (MAE & RMSE)
- **Error Magnitude**: The **LSTM** and **Linear Regression** performed best in terms of minimizing error (RMSE ~0.0099).
- **Baselines**: The simple **Linear Regression** is extremely competitive, beating the RNN, GRU, and Transformer on RMSE. This is a common finding in financial time series where the "signal" is very weak compared to noise.
...
- **Interpretation**: A low RMSE but low DA (like LSTM) implies the model is predicting close to the mean (0) conservatively, effectively minimizing squared error but failing to capture the swing direction. The GRU managed to capture some trend dynamics.

## 5. Conclusion
1.  **Linear Regression is a tough baseline**: It performs similarly to the LSTM in terms of RMSE and beat most neural models in Directional Accuracy.
...
**Recommendation**: Proceed with **GRU** for further tuning if the goal is trading strategy (DA matters), or **LSTM/Linear Regression** if the goal is volatility/risk estimation (RMSE matters).
