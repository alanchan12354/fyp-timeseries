...
def _flatten_record_for_csv(record: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "task_input": task.get("input_description"),
        "task_horizon": task.get("prediction_horizon"),
        "task_lookback": task.get("input_window"),
        "ticker": task.get("ticker"),
        "start_date": task.get("start_date"),
        "train_samples": split.get("train_samples"),
        "val_samples": split.get("val_samples"),
        ...
        "min_epochs": training.get("min_epochs"),
        "val_loss_smooth_window": training.get("val_loss_smooth_window"),
        "train_log_every": training.get("train_log_every"),
        "scheduler_type": tuning.get("scheduler_type"),
        "scheduler_factor": tuning.get("scheduler_factor"),
        "scheduler_patience": tuning.get("scheduler_patience"),
        "scheduler_min_lr": tuning.get("scheduler_min_lr"),
        "hidden": hyper.get("hidden"),
        "layers": hyper.get("layers"),
        ...
        "DA": metrics.get("DA"),
        "best_train_MSE": metrics.get("best_train_MSE"),
        "best_val_MSE": metrics.get("best_val_MSE"),
        "best_test_MSE": metrics.get("best_test_MSE"),
        "best_epoch": tuning.get("best_epoch"),
        "stop_epoch": tuning.get("stop_epoch"),
